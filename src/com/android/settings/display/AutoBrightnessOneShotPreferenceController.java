...
public class AutoBrightnessOneShotPreferenceController extends TogglePreferenceController {
    ...
    public boolean isChecked() {
        return EunoiaSettings.System.getInt(mContext.getContentResolver(),
                EunoiaSettings.System.AUTO_BRIGHTNESS_ONE_SHOT, 0) == 1;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        EunoiaSettings.System.putInt(mContext.getContentResolver(),
                EunoiaSettings.System.AUTO_BRIGHTNESS_ONE_SHOT, isChecked ? 1 : 0);
        return true;
    }
