...
public class EunoiaVersionPreferenceController extends BasePreferenceController {

    private static final String TAG = "eunoiaVersionDialogCtrl";
    ...
    public EunoiaVersionPreferenceController(Context context, String key) {
        super(context, key);
